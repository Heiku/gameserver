package com.ljh.gamedemo.module.duplicate.asyn;

import com.google.common.collect.Maps;
import com.google.common.util.concurrent.ThreadFactoryBuilder;
import com.ljh.gamedemo.module.base.asyn.run.CustomExecutor;
import com.ljh.gamedemo.module.base.asyn.run.ExecutorInit;
...
public class DuplicateManager {
    ...
    public synchronized static void unBindDupExecutor(long id){
        ...
        if (executor != null){
            for (int i = 0; i < executors.length; i++){
                if (executors[i] != null && executors[i].equals(executor)){
     ...
     * @return              线程池信息
     */
    private static CustomExecutor startExecutor(){
